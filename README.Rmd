...
R package designed to afford researchers the ability to draw stratified samples from the U.S. Department of Veteran's Affairs/Department of Defense Identity Repository (VADIR) database according to a variety of parameters. The VADIR database contains information for all veterans who were separated from the military after 1980. This package is intended to be used in conjunction with VADIR data in order to pull nationally representative samples of veterans for research purposes. Actual VADIR data not supplied with this package. More information about the VADIR database can be found [here](https://www.federalregister.gov/documents/2009/07/27/E9-17776/privacy-act-systems-of-records).

## Installation

<!-- You can install the released version of sampleVADIR from [CRAN](https://CRAN.R-project.org) with: -->
You can install the released version of the package from [CRAN](https://cran.r-project.org/web/packages/sampleVADIR/index.html), or the development version from [GitHub](https://github.com/tswanson222/sampleVADIR) with:
```{r, eval = FALSE}
